...
impl AiringEndpoint {
    ...
    /// Get upcoming episodes (user provides timestamp)
    pub async fn get_upcoming_episodes(&self, page: i32, per_page: i32) -> Result<Value, AniListError> {
    ...
    /// Get episodes airing today (user provides timestamp range)
    pub async fn get_today_episodes(&self, page: i32, per_page: i32) -> Result<Value, AniListError> {
        let options = AiringSearchOptions {
            page: Some(page),
            per_page: Some(per_page),
            ..Default::default()
    ...
    /// Get recently aired episodes (user provides timestamp)
    pub async fn get_recently_aired(&self, page: i32, per_page: i32) -> Result<Value, AniListError> {
        let options = AiringSearchOptions {
            page: Some(page),
            per_page: Some(per_page),
            ..Default::default()
    ...
    pub async fn get_schedule_for_media(&self, media_id: i32, page: i32, per_page: i32) -> Result<Value, AniListError> {
        let options = AiringSearchOptions {
            page: Some(page),
            per_page: Some(per_page),
    ...
    pub async fn get_schedule_by_id(&self, id: i32) -> Result<Value, AniListError> {
    ...
    async fn search_airing_schedule(&self, options: AiringSearchOptions) -> Result<Value, AniListError> {
        let query = include_str!("../queries/airing/airing_schedule.graphql");
