...
impl ActivityEndpoint {
    ...
    pub async fn search(&self, options: ActivitySearchOptions) -> Result<Value, AniListError> {
    ...
    pub async fn get_user_activities(&self, user_id: i32, page: i32, per_page: i32) -> Result<Value, AniListError> {
    ...
    pub async fn get_following_activities(&self, page: i32, per_page: i32) -> Result<Value, AniListError> {
        let options = ActivitySearchOptions {
            page: Some(page),
            per_page: Some(per_page),
    ...
    pub async fn get_global_activities(&self, page: i32, per_page: i32) -> Result<Value, AniListError> {
        let options = ActivitySearchOptions {
            page: Some(page),
            per_page: Some(per_page),
            sort: Some(vec![ActivitySort::IdDesc]),
    ...
    pub async fn get_by_type(&self, activity_type: ActivityType, page: i32, per_page: i32) -> Result<Value, AniListError> {
        let options = ActivitySearchOptions {
    ...
    pub async fn save_text_activity(&self, text: &str, activity_id: Option<i32>) -> Result<Value, AniListError> {
    ...
    pub async fn reply_to_activity(&self, activity_id: i32, text: &str) -> Result<Value, AniListError> {
    ...
    pub async fn save_activity_reply(&self, activity_id: i32, text: &str, reply_id: Option<i32>) -> Result<Value, AniListError> {
    ...
    pub async fn toggle_like(&self, activity_id: i32) -> Result<Value, AniListError> {
